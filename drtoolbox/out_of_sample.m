...
% (C) Laurens van der Maaten, Delft University of Technology
    ...
    if isfield(mapping, 'k') && ischar(mapping.k)
        error('This function only supports mappings with a fixed number of nearest neighbors; adaptive neighborhood selection is not supported.');
    end
